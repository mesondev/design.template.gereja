...
- Dashboard modern menggunakan SB Admin Bootstrap 5
- Statistik data gereja
- Sidebar responsive
- Login Authentication Laravel
- Grafik statistik jemaat
...
d software licensed under the [MIT license](https://opensource.org/licenses/MIT).
